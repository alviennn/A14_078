...
import com.example.myapplication.ui.viewmodel.villa.InsertVillaUiEvent
import com.example.myapplication.ui.viewmodel.villa.InsertVillaUiState
...
object DestinasiInsertVilla : DestinasiNavigasi {
    ...
    val descriptionRes = "Masukkan data Villa"
}
    ...
    Scaffold(
        ...
        topBar = {
            CustomTopAppBar(
                ...
                description = DestinasiInsertVilla.descriptionRes,
        ...
        EntryVillaBody(
            ...
            onSaveClick = {
                coroutineScope.launch {
                    ...
                    snackbarHostState.showSnackbar("Data Villa berhasil disimpan!")
                }
            },
            modifier = Modifier
...
fun EntryVillaBody(
    ...
    Column (
        ...
        FormInputVilla(
            insertUiEvent = insertUiState.insertVillaUiEvent,
...
@Composable
fun FormInputVilla(
    insertUiEvent: InsertVillaUiEvent,
    modifier: Modifier = Modifier,
    ...
    Column(
        ...
        OutlinedTextField(
            value = insertUiEvent.namaVilla,
            onValueChange = { onValueChange(insertUiEvent.copy(namaVilla = it)) },
        ...
        OutlinedTextField(
            value = insertUiEvent.kamarTersedia.toString(),
            onValueChange = { onValueChange(insertUiEvent.copy(kamarTersedia = it.toIntOrNull() ?: 0)) },
